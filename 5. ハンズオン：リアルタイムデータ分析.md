...
#### 1. Cosmos DB のデプロイと Synapse Link を有効化したコンテナ（分析ストア）の作成
...
#### 4. 補足：Serverless SQL からの Cosmos DB トランザクションストアの Read  
